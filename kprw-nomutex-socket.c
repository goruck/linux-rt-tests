...
#define SEVEN	"1111111110001101111111111111111111111111111111111111111111111111"
...
int main(int argc, char *argv[])
{
  ...
  pthread_attr_setschedparam(&my_attr, &param_pio);
  res = pthread_create(&mio_thread, &my_attr, msg_io, (void *) &connfd);
  if (res != 0) {
